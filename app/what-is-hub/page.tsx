...
const modules = [
  {
    ...
    description: "If you want to explore a technical subject or realize a project that is close to your heart this unit is for you! If your subject is validated by your pedagogical team, you can be rewarded some credits for your personal work.",
  ...
  },
  {
    ...
    description: "A hackathon is an event where programmers and other tech enthusiasts collaborate intensively to create software or hardware projects within a short time frame, typically ranging from 1 to 2 days (often on the week-ends!). It's often competitive and focused on innovation and problem-solving.",
  ...
  },
  {
    ...
    description: "This unit brings together all the lectures, workshops and conferences you can attend during your year. These activities are designed to help you familiarise yourself with different technical subjects and explore horizons you might not have thought of.",
  ...
  },
  {
    ...
    credit: "1 credit = 10 hours",
    description: "A User Group is a community of individuals who use a specific technology, software, or service, sharing knowledge, best practices, and experiences. This unit is here to organize the user groups among students and show their activities.",
...
const faqData = [
  ...
  },
  {
    ...
    answer: "Talks and Conferences are activities that only require audience attention with no interaction (like talk lectures). User Groups are interactive activities requiring public participation and actions (like workshops).",
  },
  {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              The HUB is where we create and manage projects, talks, workshops, hackathons and experiences at Epitech. 
              <span className="font-bold"> One advice? </span> Be as creative and proactive as possible, the HUB is a place for you to express yourself and your ideas.
            </p>
      ...
      <div className="bg-white/50 backdrop-blur-sm py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">How does it work?</h2>
